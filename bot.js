...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'kes') {
    msg.reply('LÜTFEN DAHA SAYGILI OL !');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'oç') {
    msg.reply('KÜFÜR İYİ BİRŞEY DEĞİLDİR DOSTUM');
  }
});
client.on('message', msg => {
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'selam') {
    msg.reply('SELAM HOŞ GELDİN <3');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'naber') {
    msg.reply('İYİDİR SENDEN .');
  }
});

client.on('message', msg => {
  if (msg.content.toLowerCase() === 'amk') {
    msg.reply('ÇOK KÜFÜR İYİ DEĞİLDİR KANKAM');
  }
});
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'veled') {
    msg.reply('LÜTFEN BÖYLE KONUŞMA !');
  }
});
